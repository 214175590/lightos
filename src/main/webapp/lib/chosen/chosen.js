...
(function() {
    ...
    AbstractChosen = (function() {
        ...
        AbstractChosen.prototype.results_option_build = function(options) {
            var content, data, _i, _len, _ref, $num = this.chosen_pager.find('.pager-num').first();
            content = '', start = 0, end = 0;
            _ref = this.results_data;
            end = _ref.length;
            if(options && typeof(options) === 'string'){
            	var _refTemp = [];
            	for(_i = 0, _len = end; _i < _len; _i++) {
            		data = _ref[_i];
            		if(data.search_text_match === true){
            			_refTemp.push(data);
            		}
            	}
            	_ref = _refTemp;
            ...
            if(this.pageSize <= _ref.length){
            	this.chosen_pager.show();
            	this.chosen_pager.removeClass('hidden');
            	var max = parseInt(_ref.length / this.pageSize) + (_ref.length % this.pageSize == 0 ? 0 : 1);
                if(this.pageIndex > max && max > 0){
                	this.pageIndex = max;
                }
                ...
                $num.text(" " + this.pageIndex + "/" + max);
            } else {
            	this.chosen_pager.hide();
            }
            for(_i = start, _len = end; _i < _len; _i++) {
                data = _ref[_i];
                if(data.group) {
        ...
        AbstractChosen.prototype.result_add_option = function(option) {
            ...
            if(option.innerHTML === undefined && option.title === "错误数据") {
                classes.push("error-data");
            }
    ...
    Chosen = (function(_super) {
        ...
        Chosen.prototype.set_up_html = function() {
            ...
            if(this.is_multiple) {
                ...
                this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul class="chosen-results"></ul><div class="chosen-pager hidden"><span class="btn btn-mini p-up">上一页</span><span class="btn btn-mini p-next">下一页</span><span class="pager-num"></span></div></div>');
            }
            this.form_field_jq.hide().after(this.container);
            this.dropdown = this.container.find('div.chosen-drop').first();
            this.search_field = this.container.find('input').first();
            this.search_results = this.container.find('ul.chosen-results').first();
            this.chosen_pager = this.container.find('div.chosen-pager').first();
            this.search_field_scale();
            ...
            this.results_build();
            var that = this;
            this.chosen_pager.find('.btn').bind('click', function(){
            	var $this = $(this);
            	if($this.hasClass('p-up')){
            		if(that.pageIndex > 1){
